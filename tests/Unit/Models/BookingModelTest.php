...
it('auto-generates uuid and booking_reference on create', function () {
    $customer = User::create(['uuid' => (string) str()->uuid(), 'name' => 'test', 'email' => 'test@ex.com', 'password' => '123', 'role' => \App\Enums\UserRole::Customer, 'status' => \App\Enums\UserStatus::Active]);
